<template>
	<div class="app-contain" :style='{"width":"1200px","padding":"0px 0px 20px","margin":"0px auto 40px","position":"relative","borderRadius":"0px","background":"none"}'>
				...
				tr {
					...
					td {
						...
						.cell {
							...
							// 取消订单
							.cancel_btn {
								border: 0px solid rgba(4,133,156,.3);
								cursor: pointer;
								border-radius: 4px;
								padding: 0 10px;
								margin: 0 5px 6px 0;
							...
							// 退款
							.refundPrice_btn {
								border: 0px solid rgba(156,4,4,.3);
								cursor: pointer;
								border-radius: 4px;
								padding: 0 20px;
								margin: 0 5px 6px 0;
							...
							// 物流
							.logistics_btn {
								border: 0px solid rgba(2,102,181,.3);
								cursor: pointer;
								border-radius: 4px;
								padding: 0 20px;
								margin: 0 10px 6px 0;
