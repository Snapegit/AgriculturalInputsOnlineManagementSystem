...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
			form.value.fankuishijian = context?.$toolUtil.getCurDate()
		if(formId){
			id.value = formId
			type.value = formType
		}
		...
		context?.$http({
			...
			if(json.hasOwnProperty('nongminzhanghao') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.nongminzhanghao = json.nongminzhanghao
				disabledForm.value.nongminzhanghao = true;
			}
			if(json.hasOwnProperty('nongminxingming') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
