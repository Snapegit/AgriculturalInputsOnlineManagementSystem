		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item prop="nongminzhanghao" label="农民账号">
								<el-input class="list_inp" v-model="userForm.nongminzhanghao" placeholder="农民账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
						...
						<el-col :span="24">
							<el-form-item prop="nongminxingming" label="农民姓名">
								<el-input class="list_inp" v-model="userForm.nongminxingming" placeholder="农民姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="jiatingzhuzhi" label="家庭住址">
								<el-input class="list_inp" v-model="userForm.jiatingzhuzhi" placeholder="家庭住址" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
						...
						<el-col :span="24">
							<el-form-item prop="dikuaimingcheng" label="地块名称">
								<el-input class="list_inp" v-model="userForm.dikuaimingcheng" placeholder="地块名称" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="地块类型" prop="dikuaileixing">
								<el-select
									class="list_sel"
									v-model="userForm.dikuaileixing" 
									placeholder="请选择地块类型"
									style="width:100%;"
									>
									<el-option v-for="(item,index) in dikuaileixingLists" :label="item" :value="item">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="tudimianji" label="土地面积">
								<el-input class="list_inp" v-model="userForm.tudimianji" placeholder="土地面积" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.nongminzhanghao)
	...
	const init = () => {
		...
		menuList.value = arr
		dikuaileixingLists.value = "大田,大棚,果园".split(',')
		getSession()
	}
	//菜单悬浮的显示与隐藏
