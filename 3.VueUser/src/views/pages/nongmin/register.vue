	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">农民账号：</div>
					<input class="list_inp"
					 v-model="registerForm.nongminzhanghao" 
					 placeholder="请输入农民账号"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">农民姓名：</div>
					<input class="list_inp"
					 v-model="registerForm.nongminxingming" 
					 placeholder="请输入农民姓名"
					 type="text"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">家庭住址：</div>
					<input class="list_inp"
					 v-model="registerForm.jiatingzhuzhi" 
					 placeholder="请输入家庭住址"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">地块名称：</div>
					<input class="list_inp"
					 v-model="registerForm.dikuaimingcheng" 
					 placeholder="请输入地块名称"
					 type="text"
					 />
				</div>
				<div class="list_item">
					<div class="list_label">地块类型：</div>
					<el-select 
						class="list_sel" 
						v-model="registerForm.dikuaileixing" 
						placeholder="请选择地块类型"
						>
						<el-option v-for="item in nongmindikuaileixingLists" :label="item" :value="item"></el-option>
					</el-select>
				</div>
				<div class="list_item">
					<div class="list_label">土地面积：</div>
					<input class="list_inp"
					 v-model="registerForm.tudimianji" 
					 placeholder="请输入土地面积"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const nongmindikuaileixingLists = ref([])
	const init=()=>{
		nongmindikuaileixingLists.value = "大田,大棚,果园".split(',')
	}
