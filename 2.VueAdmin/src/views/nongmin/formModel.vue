		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="地块名称" prop="dikuaimingcheng">
							<el-input class="list_inp" v-model="form.dikuaimingcheng" placeholder="地块名称"
								 type="text" 								:readonly="!isAdd||disabledForm.dikuaimingcheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="地块类型" prop="dikuaileixing">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.dikuaileixing?true:false"
								v-model="form.dikuaileixing" 
								placeholder="请选择地块类型"
								>
								<el-option v-for="(item,index) in dikuaileixingLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="12">
						<el-form-item label="土地面积" prop="tudimianji">
							<el-input class="list_inp" v-model="form.tudimianji" placeholder="土地面积"
								 type="text" 								:readonly="!isAdd||disabledForm.tudimianji?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='dikuaimingcheng'){
					form.value.dikuaimingcheng = row[x];
					disabledForm.value.dikuaimingcheng = true;
					continue;
				}
				if(x=='dikuaileixing'){
					form.value.dikuaileixing = row[x];
					disabledForm.value.dikuaileixing = true;
					continue;
				}
				if(x=='tudimianji'){
					form.value.tudimianji = row[x];
					disabledForm.value.tudimianji = true;
					continue;
				}
				if(x=='touxiang'){
