		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item prop="qiyezhaopian"
									  label="企业照片"
						>
							<uploads
					...
					<el-col :span="24">
						<el-form-item label="企业简介" prop="qiyejianjie">
							<editor :value="form.qiyejianjie" placeholder="请输入企业简介" :readonly="!isAdd||disabledForm.qiyejianjie?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.qiyejianjie = res.data.data.qiyejianjie?(res.data.data.qiyejianjie.replace(reg,'../../../cl84235399/file')):'';
