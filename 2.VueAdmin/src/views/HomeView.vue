				...
				<el-card v-show="cardTypeList.closeordersChartType1" class="card_view">
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddenordersChartType1">
							<div id="orderstotalEchart1" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
				...
				<el-card v-show="cardTypeList.closeordersChartType2" class="card_view">
						...
						<div class="index_card_head">
							...
							<div class="card_head_right">
								<el-icon @click="cardTypeClick('hiddenordersChartType2')" class="showIcons"
									:class="cardTypeList.hiddenordersChartType2?'showIcons1':''">
									<ArrowUpBold />
								</el-icon>
					...
					<el-collapse-transition>
						<div class="card_item" v-show="cardTypeList.hiddenordersChartType2">
							<div id="ordersbuynumberEchart2" style="width: 100%;height: 400px;"></div>
						</div>
					</el-collapse-transition>
				</el-card>
			</el-collapse-transition>
...
<script setup>
	...
	const getordersChart1 = () => {
		nextTick(()=>{
			var totalEchart1 = echarts.init(document.getElementById("orderstotalEchart1"),'macarons');
			context?.$http({
	...
	const getordersChart2 = () => {
		nextTick(()=>{
			var buynumberEchart2 = echarts.init(document.getElementById("ordersbuynumberEchart2"),'macarons');
			context?.$http({
...
<style lang="scss">
	...
	.home_view {
		padding: 0px 20px;
		margin: 0;
		background: url(http://clfile.zggen.cn/20240417/41207a459fdc41d182fa01f86aa9056c.png) no-repeat center top / 100% 100% !important;
		width: 100%;
		min-height: 100vh;
		height: auto;
	}
