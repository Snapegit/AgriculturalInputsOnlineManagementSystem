	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('yonghufankui','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
...
<script setup>
	...
	const approvalClick = (row) => {
		let params = {
			id:row.id,
			biaoti: row.biaoti,
			fankuineirong: row.fankuineirong,
			fankuishijian: row.fankuishijian,
			nongminzhanghao: row.nongminzhanghao,
			nongminxingming: row.nongminxingming,
			shhf: row.shhf,
		}
		nextTick(() => {
